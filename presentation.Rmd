...
> - Worked briefly in data analytics roles in labs in Vancouver, BC and at the Fred Hutchinson Cancer Research Center in Seattle (primarily with large genomic datasets)
...
... even though it was a severely limited view (non-interactive, only 1000 rows).
...
So, if you need to dip into SQL, JavaScript, or Python, RStudio can still do a somewhat reasonable job of providing you with completion items.
